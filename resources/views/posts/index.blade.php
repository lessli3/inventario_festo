...
@section('content')
<h1>Lista de Herramientas y Stock</h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('posts.adjustarStock', ['post' => $post->id, 'action' => 'decrease']) }}" method="POST" class="d-inline" title="Sustraer Stock">
                            @csrf
                        ...
                        <form action="{{ route('posts.adjustarStock', ['post' => $post->id, 'action' => 'increase']) }}" method="POST" class="d-inline" title="Sumar Stock">
                            @csrf
                        ...
                        <form action="{{ route('posts.destroy', $post->id) }}" method="POST" class="d-inline" title="Eliminar">
                            @csrf
                            @method('DELETE')
